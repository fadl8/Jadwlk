...
Color color;
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: Stack(
        children: <Widget>[
          imge(widget.model, context,color),
          Container(
            color: Colors.white,
                                ...
                                child: Container(
                                  decoration: BoxDecoration(
                                      image: DecorationImage(
                                          image: CachedNetworkImageProvider(widget.model.bg!=null?widget.model.bg.path:" "),
                                          fit: BoxFit.fill)),
                            ...
                            Config.getlogin()
                                ? Row(
                                 ...
                                 fill&&!editmod?  FlatButton.icon(
                                    ...
                                    icon:
                                        Icon(Icons.format_color_text, color: Colors.white),
                                    label: Text(
                                     color==Colors.black?"لون الخط :ابيض":"لون الخط :اسود" ,
                                      style: TextStyle(color: Colors.white),
                                    )):Container(),
                                     fill && !editmod&&Config.getType() == 0
                                          ? FlatButton.icon(
                                              color: prymaryColor,
                                              onPressed: () async {
