...
class TablesPage extends StatefulWidget {
  ...
  TablesPage({this.model,this.owner = false, this.id = 0, this.appbar = true, Key key})
      : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: widget.appbar
          ? AppBar(
              title: Text( widget.model!=null?widget.model.name:" "),
              centerTitle: true,
            )
          : null,
              ...
              onPressed: () {
                ...
                Navigator.push(
                    ...
                    MaterialPageRoute(
                        builder: (context) => ChangeNotifierProvider(
                              create: (context) =>
                                  TablesProvider("url", n:widget.model!=null?widget.model.name: " ",d: widget.model!=null?widget.model.id:0),
