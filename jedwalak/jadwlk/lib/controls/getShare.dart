...
class Config{
  ...
  static Future init() async
  {
    await SharedPreferences.getInstance().then((onValue)
    {
      ...
      if (onValue.getDouble("charge")==null)
        onValue.setDouble("charge", 100);
 
      if (onValue.getInt("id")==null)
        onValue.setInt("id", 0);
 
      if (onValue.getString("f_name")==null)
        onValue.setString("f_name", "f_name");
      if (onValue.getString("l_name")==null)
        onValue.setString("l_name", "l_name");
      ...
      if (onValue.getString("token")==null)
        onValue.setString("token", "0");
